...
class InventarioTienda:
        ...
        try:
            with open(self.archivo, "w", encoding="utf-8") as f:
                for articulo in self.articulos.values():
                    f.write(f"{articulo.codigo},{articulo.nombre},{articulo.stock},{articulo.precio}\n")
    ...
    def cargar_desde_archivo(self):
        """Carga los artículos desde el archivo al iniciar el inventario."""
        try:
            with open(self.archivo, "r", encoding="utf-8") as f:
                for linea in f:
                    codigo, nombre, stock, precio = linea.strip().split(",")
                    self.articulos[codigo] = Articulo(codigo, nombre, int(stock), float(precio))
    ...
    while True:
        ...
        if opcion == '6':
            ...
            try:
                ...
                print(" Error: El stock debe ser un número entero y el precio un número decimal.")
        elif opcion == '2':
